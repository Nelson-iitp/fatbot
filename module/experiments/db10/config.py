...
class C(PPOCONFIG):
    ...
    def build_base(self):
        ...
        self.base_total_timesteps = 175_000
    ...
    def build_aux(self):
        ...
        self.aux_horizon=int(self.base_horizon*0.5) # select-arg
        ...
        self.aux_total_timesteps = 150_000
...
class CC(C):
    ...
    def build_rewards(self):
        self.base_reward_scheme = dict(
            dis_target_point=           0.0,
            dis_neighbour=              1.0,
            hull_formed=                0.0,
            dis_target_radius=          0.0,
            all_unsafe=                 1.0,
            all_neighbour=              1.0,
            occluded_neighbour=         1.0,
        )  
